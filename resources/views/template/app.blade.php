    ...
    <div class="main-wrapper main-wrapper-1">
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            <li class="menu-header"><i class="fas fa-landmark"></i><span> Menu Utama</span></li>
                <li class="nav-item{{ request()->is('pengguna') ? ' active' : '' }}"><a href="{{ url('/pengguna') }}"><i class="fas fa-user-friends"></i><span>Customer</span></a></li>
                <li class="nav-item{{ request()->is('kwintasi') ? ' active' : '' }}"><a href="{{ url('/kwintasi') }}"><i class="fas fa-chalkboard-teacher"></i><span>Kamar</span></a></li>
                <li class="nav-item{{ request()->is('sewa') ? ' active' : '' }}"><a href="{{ url('/sewa') }}"><i class="fas fa-book-open"></i><span>Invoice</span></a></li>
                <li class="nav-item{{ request()->is('invoice') ? ' active' : '' }}"><a href="{{ url('/invoices') }}"><i class="fas fa-users"></i><span>Pembayaran</span></a></li>
                <li class="nav-item{{ request()->is('penyewa') ? ' active' : '' }}"><a href="{{ url('/penyewas') }}"><i class="fas fa-user-graduate"></i><span>Reservasi</span></a></li>
              </ul>
            </li>
          </ul>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2024 <div class="bullet"></div> Design By <a href="https://nauval.in/">FHAZA ZINGDADIL</a>
        </div>
